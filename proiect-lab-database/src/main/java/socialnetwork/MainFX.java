...
public class MainFX extends Application {
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        PaginatedRepository<Long, Event>eventsRepository = new EventDbRepository(url,username, password,  new EventValidator(),pageSize);
        ...
        CommunityService communityService=new CommunityService(userRepository,messagesRepository,friendRequestRepository,friendshipsRepository,eventsRepository);
