...
public class InboxController implements Observer
{
    ...
    @FXML
    TableColumn<Message,String> tableColumnId;
    @FXML
    ...
    public void initialize()
    {
        ...
        tableColumnId.setCellValueFactory(new PropertyValueFactory<Message, String>("idMessage"));
    ...
    public void send_message(ActionEvent actionEvent)
    {
        ...
        try
        {
            Long reply = tableView.getSelectionModel().getSelectedItem().getIdMessage();
            Message m = new Message(message,user,reply);
