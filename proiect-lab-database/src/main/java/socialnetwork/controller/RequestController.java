            ...
            if (toUser.equals(user))
            {
                try {
                    ...
                    if (c.equals("ACCEPT"))
                    {
                        ...
                        {
                            Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Congrats!You and " + toUser.getFirstName() + " are now friends!", ButtonType.OK);
                        ...
                        if (service.acceptFriendRequest(user, fromUser, RequestStatus.REJECTED) == null) {
                            Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Congrats!You and " + toUser.getFirstName() + " are not friends!", ButtonType.OK);
                            alert.setResizable(true);
                            alert.showAndWait();
                        } else {
                            Alert alert = new Alert(Alert.AlertType.INFORMATION, "Something went wrong! Please try again!", ButtonType.OK);
